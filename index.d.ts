export function SetWindowPosition(hWnd: number, hWndInsertAfter: number, x: number, y: number, cx: number, cy: number, uFlags: number): boolean | undefined;
export function ParentToDesktop(hWnd: number): boolean | undefined;
